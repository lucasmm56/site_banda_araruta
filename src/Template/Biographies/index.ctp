<section class="content">
    <fieldset style="text-align:center;">
        <h1>Sobre a banda Araruta</h1>
        <p>O texto dissertativo é um dos estilos de escrita mais exigidos nos concursos, em vestibulares e outras provas.
        ...
        Mas este dado não serve para desanimá-lo e, sim, para incentivá-lo a fazer parte desse seleto grupo de pessoas.
        Portanto, se você quer conhecer mais sobre as características desse gênero da escrita e aprender como elaborar um texto dissertativo, vale acompanhar este artigo até o final.
        Nas próximas linhas, além de descobrir qual é a estrutura adequada para a redação, você verá dicas de como escrever um texto dissertativo excelente.
        Avance na leitura!</p>
    </fieldset>
</section>